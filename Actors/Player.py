...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if (keystate[K_DOWN] or keystate[K_s]) and (keystate[K_LEFT] or keystate[K_a] or keystate[K_q]):
            ...
            self.move('south-est')
        elif (keystate[K_UP] or keystate[K_w] or keystate[K_z]) and (keystate[K_RIGHT] or keystate[K_d]):
            self.move('north-est')
        elif (keystate[K_UP] or keystate[K_w] or keystate[K_z]) and (keystate[K_LEFT] or keystate[K_a] or keystate[K_q]):
